...
// ErrorHandler
bool IVIManifest::warning(const QXmlParseException& exception)
{
    qDebug() << "[WARNING] line" << exception.lineNumber() << ":" << exception.message();
    return true;
}

bool IVIManifest::error(const QXmlParseException& exception)
{
    qDebug() << "[ERROR] line" << exception.lineNumber() << ":" << exception.message();
    return true;
}

bool IVIManifest::fatalError(const QXmlParseException& exception)
{
...
// ContentHandler
bool IVIManifest::startElement(const QString& ns, const QString& localName, const QString& qName, const QXmlAttributes& atts)
{
    Q_UNUSED(ns)
    Q_UNUSED(localName)
...
bool IVIManifest::characters(const QString& ch)
{
    switch(state)
    {
    case RootState:
...
bool IVIManifest::endElement(const QString&, const QString&, const QString&)
{
    switch(state)
    {
    case RootState:
